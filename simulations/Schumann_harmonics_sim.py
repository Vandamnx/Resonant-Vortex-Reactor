...
plt.title('Frequency Spectrum (0–180 Hz) — Note the peaks at target frequencies', fontsize=12)
...
print("the exact frequency combination used in the Molecular Healing Head v4.1 tuning.")
print("\nNext steps: Experiment with different amplitude ratios or add 963 Hz / other Solfeggio tones.")