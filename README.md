...
<!-- DON'T EDIT THIS SECTION, INSTEAD RE-RUN doctoc TO UPDATE --># Resonant Vortex Reactor (RVR)
...
python Healing_head_sim.py<!-- END doctoc generated TOC please keep comment here to allow auto update -->